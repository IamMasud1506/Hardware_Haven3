        ...
        <section class="featured-products">
            <div class="container">
                ...
                <div class="product-grid">
                    <div class="product-card" data-product-id="1" data-name="Cordless Drill 18V" data-price="7500.00">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                <button class="quick-view-btn" onclick="openModal('Cordless Drill 18V', 'Versatile power tool with battery and charger.', 'images/drill.jpg', 7500.00)">Quick View</button>
                                <button class="add-to-cart-btn" onclick="addToCart(1)">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                    <div class="product-card" data-product-id="2" data-name="Claw Hammer 16oz" data-price="1300.00">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                <button class="quick-view-btn" onclick="openModal('Claw Hammer 16oz', 'Essential hand tool for carpentry.', 'images/hammer.jpg', 1300.00)">Quick View</button>
                                <button class="add-to-cart-btn" onclick="addToCart(2)">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                    <div class="product-card" data-product-id="3" data-name="LED Bulb 60W" data-price="300.00">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                <button class="quick-view-btn" onclick="openModal('LED Bulb 60W', 'Long-lasting light bulb.', 'images/bulb.jpg', 300.00)">Quick View</button>
                                <button class="add-to-cart-btn" onclick="addToCart(3)">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                    <div class="product-card" data-product-id="4" data-name="Star Cement 50lb" data-price="1000.00">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                <button class="quick-view-btn" onclick="openModal('Star Cement 50lb', 'Versatile base for construction mixes.', 'images/starcement.jpg', 1000.00)">Quick View</button>
